...
parser.add_argument('--word_dim', type=int,default=200, help='dimension of word vector', required=True)
parser.add_argument('--sentence_length', type=int,default=80, help='max sentence length', rquired=True)
parser.add_argument('--class_size', type=int,default=7, help='number of classes', required=True)
